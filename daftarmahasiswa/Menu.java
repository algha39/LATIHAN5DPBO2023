...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        ...
        // Dummy
        listMhs.add(new Mahasiswa("2105673", "Alghaniyu Naufal", "A", "Laki-laki"));
        listMhs.add(new Mahasiswa("2101103", "Nelly Joy", "B+", "Perempuan"));
        listMhs.add(new Mahasiswa("2202222", "M.Satria", "B", "Laki-laki"));
        // Set Table
    ...
    private void initComponents() {
        ...
        jComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Laki-laki", "Perempuan" }));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(!fieldNim.getText().isEmpty() && !fieldNama.getText().isEmpty() && !fieldNilai.getText().isEmpty()){
            if (isUpdate == false)
                    insertData();
            else{
                updateData();
            ...
            JOptionPane.showMessageDialog(null, "Tolong lengkapi datanya!");
        }
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        jComboBox.setSelectedItem(selectedGender);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        int msg = JOptionPane.showConfirmDialog(null, "Ingin menghapus data ini?", "Delete", JOptionPane.YES_NO_OPTION);
    ...
    private void jComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxActionPerformed
        // TODO add your handling code here:
        if(jComboBox.getSelectedItem().equals("Laki-laki")){
            gdr = "Laki-laki";
        }
        else if(jComboBox.getSelectedItem().equals("Perempuan")){
            gdr = "Perempuan";
        }
